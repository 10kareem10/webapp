...
<?php
        ...
        function displayPosts($con)
        {
          ...
          while ($post_row = mysqli_fetch_array($result_posts)) {
            ...
            echo "<img src='<?php echo $poster_photo; ?>'> <h6 id='postName'>$poster_name </h6>";
     ...
     <input class='likebtn' type='submit' value='like' name='like'> </i>
     ...
     <input class='commentbtn' type='submit' value='comment' name='comment' onclick='addInput()'>
     
<input id='commentfield' type='text' class='form-control'>
...
/*<input type='text' class='form-control'>*/
            while ($comment_row = mysqli_fetch_array($result_comments)) {
              ...
              if ($comment_post_id == $post_id){
                echo "<img src='<?php echo $commenter_photo; ?>'> <h6 id='postName'> $commenter_name </h6>";
